    ...
    <section className="hero hero--video">
      ...
      <div className="hero__content text-center">
        <h1 className="display-5 mb-6 font-bold">
          <span className="text-[hsl(45.52_74.36%_92.35%)] text-shadow-md text-5xl md:text-6xl">Lift Your Energy.</span><br />
          <span className="text-[hsl(47.12_72.24%_51.96%)] font-semibold drop-shadow-lg text-4xl md:text-5xl">Quiet Your Mind.</span>
        </h1>
        <p className="lead mb-8 text-[hsl(45.52_74.36%_92.35%)] max-w-lg mx-auto drop-shadow-sm text-xl font-medium">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-2 border-[hsl(47.12_72.24%_51.96%)] text-[hsl(47.12_72.24%_51.96%)] hover:bg-[hsl(47.12_72.24%_51.96%)] hover:text-[hsl(342.35_9.6%_34.71%)] backdrop-blur-sm font-semibold text-lg px-8 py-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
          >
            <Link to="/membership">Membership &amp; Rates</Link>
          </Button>
        </div>
        <div className="mt-4 font-medium space-y-1">
          <div className="text-lg text-[hsl(45.52_74.36%_92.35%)] drop-shadow-sm">You Belong Here</div>
